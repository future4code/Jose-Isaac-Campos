  ...
  createUser = async () => {
    ...
    try {
        ...
        if (
            ...
            "User information are missing. Name and email are required."
          ) {
          ...
          if (
            error.response.data.message ===
            "There is an user with this name or this email"
          ) {
          ...
          if (error.response.data.message === 'data is not defined') {
              alert("Usuário ou email já cadastrado no sistema")
          }
    }
  };
